...
<body
	...
	<div>
		<div
			...
			<span
				style="margin-left: 1%; text-shadow: 2px 2px 10px black; font-size: 5vh; color: white">TwittTrend</span>
			<span
	...
	<script>
		...
		var localIP = document.domain;
		//delete "/twitttrend" when deployed to aws beanstalk
		var wsUri = "ws://" + localIP + ":8080/server";
		var websocket;
			...
			websocket.onmessage = function(evt) {
				...
				if(type == 'SearchResult'){
					...
					if(dataList.length > 0){
						...
						alert("No tweets about this keyword!");
					}
